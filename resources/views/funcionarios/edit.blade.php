...
<div class="card">
    ...
    <div class="container pt-5">
        ...
        <form action="/funcionarios.edit/{{ $funcionario->id }}" method="POST" enctype="multipart/form-data">
            @csrf
    ...
    <div class="card-body">
        ...
        @if (isset($funcionario))
            <form action="/funcionarios/{{ $funcionario->id }}" method="POST" enctype="multipart/form-data">
            @method('POST')
        @else
            <form action="/funcionarios.edit" method="POST" enctype="multipart/form-data">
        @endif
            ...
            <div class="form-group">
                ...
                <select name="contrato" class="form-control">
                    <option value="F" {{ isset($funcionario) && $funcionario->status == "C" ? "selected='selected'" : "" }}>CLT</option>
                    <option value="J" {{ isset($funcionario) && $funcionario->status == "A" ? "selected='selected'" : "" }}>AVULSO</option>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <select name="status" class="form-control">
                    <option value="A" {{ isset($funcionario) && $funcionario->status == "A" ? "selected='selected'" : "" }}>Ativo</option>
                    <option value="D" {{ isset($funcionario) && $funcionario->status == "D" ? "selected='selected'" : "" }}>Desligado</option>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="date" name="data_rescisao" class="form-control" data-provide="datepicker" data-date-language="pt-BR" value="{{ isset($funcionario) ? $funcionario->data_rescisao : '' }}">
            </div>
