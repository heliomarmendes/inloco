...
<div class="card">
    ...
    <div class="container pt-5">   
        ...
        <form action="/alimentacoes.create" method="POST" enctype="multipart/form-data">
            @csrf
    ...
    <div class="card-body">
        ...
        @if (isset($funcionario))
            <form action="/alimentacoes.create/{{ $alimentacao->id }}" method="POST" enctype="multipart/form-data">
            @method('GET')
                @else
                    <form action="/alimentacoes.create" method="POST" enctype="multipart/form-data">
        @endif
            ...
            <div class="form-group">
                <label for="data_alimentacao">Mês Alimentação</label>
                <input type="date" name="data_alimentacao" class="form-control" data-provide="datepicker" data-date-language="pt-BR">
            </div>

            <button type="submit" class="btn btn-primary">Salvar</button>
            <a href="/alimentacoes.index" class="btn btn-light">Voltar</a></button>
